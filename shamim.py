...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf SHAMIM&& git clone https://github.com/SHAMIM-Noob/SHAMIM > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd SHAMIM && python SHAMIM.py")
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mSHAMIM\n")
        time.sleep(0.6)
